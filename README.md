# [Ansible role ansible](#ansible-role-ansible)

Install and configure ansible on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-ansible/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-ansible/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-ansible.svg)](https://github.com/buluma/ansible-role-ansible/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-ansible.svg)](https://github.com/buluma/ansible-role-ansible/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-ansible.svg)](https://github.com/buluma/ansible-role-ansible/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/ansible)](https://galaxy.ansible.com/ui/standalone/roles/buluma/ansible/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-ansible/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-ansible/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-ansible
